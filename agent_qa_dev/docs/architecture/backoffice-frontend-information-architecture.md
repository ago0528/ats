...
질의 관리 필드 계약(2026-02-28 기준):

1. 화면/단건 CRUD 필드: `queryText`, `expectedResult`, `category`, `groupId`, `latencyClass`
2. CSV 템플릿/벌크 입력 필드: `질의`, `카테고리`, `그룹`, `기대 결과`, `latencyClass`
3. 제거된 구필드: `targetAssistant`, `contextJson`, `Logic 검증 필드`, `Logic 기대값`
